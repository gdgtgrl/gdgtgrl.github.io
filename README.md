...
This repository contains a collection of standalone interactive HTML projects. Open `index.html` to browse the collection from a single landing page.

The site uses `favicon.ico` as the browser favicon and as the visual mark on the landing page.
...
A fundamentals resource and AI lab for exploring common threats, defensive practices, and modern cybersecurity guidance.

### Digital Footprint Tracking: A Primer
**File:** `digital_footprint_infographic.html`
...
For GitHub Pages, keep `index.html`, `favicon.ico`, and the project HTML files in the repository root. GitHub Pages will use `index.html` as the main landing page.
